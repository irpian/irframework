...
class Route {
    ...
    function route($route="", $path_to_include=""){
      ...
      //$register = false;
      //$register = $this->register($route);

      // if(file_exists(base_root.'/themes/'.$themes_name.'/modules/'.$modules.'/'.$path_to_include)){
      //   die("here");
      //   $path_to_include = $this->theme->base().$path_to_include;
      ...
      //if($register==true){
        ...
        if(file_exists($this->theme->base().'modules/'.$modules.'/'.$path_to_include)){
    ...
    function state(){
     ...
     function set(){
         ...
         //$module = $this->module;
         $modules = $this->module->set();
         $available = $this->module->available();
    ...
    //   if($state!="frontend") {
    //     if((empty($path[1]) && $register=="/") && $modules==$config['module']['default']){
    //       die("true 1 ".$modules);
    //       return true;
    //     }elseif((isset($path[1]) && $register=="/") && $path[1]==$config['module']['default']){
    //       die("true 3 ".$modules);
    //       return true;
    //     }elseif(isset($path) && $path[1]!="" && $path[1]==$register && $modules!=$config['module']['default']){
    //       die("true 2 ".$modules);
    //       return true;
    //     } else {
    //       die("false ".$modules);
    ...
    //     }
    //   } else {
    //     if(empty($path[0]) && $register=="/" && $modules==$config['module']['default']){
    //       return true;
    //     }elseif((isset($path[0]) && $register=="/") && $path[0]==$config['module']['default']){
    //       die("true 3 ".$modules);
    //       return true;
    //     }elseif(isset($path) && $path[0]!="" && $path[0]==$register && $modules!=$config['module']['default']){
    //       return true;
    //     } else {
    //       die("false ".$path[0]."-".$register);
    //       return false;
    //     }
    //   }
