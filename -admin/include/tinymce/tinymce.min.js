...
tinymce.init({
    ...
    selector: "textarea.ckeditor",
	imageupload_url: 'http//:commerce.jcamp.biz/syaiful/includes/',
    theme: "modern",
    plugins: [
        "advlist autolink lists link image charmap print preview hr anchor pagebreak",
        "searchreplace wordcount visualblocks visualchars code fullscreen",
...
//         "emoticons template paste textcolor colorpicker textpattern  "
//     ],
//     toolbar1: "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image", file_browser_callback: RoxyFileBrowser});
//cadangan plugins -- fullscreen
...
//light
  tinymce.init({selector: '.tinymce',
	...
	valid_children : "+body[style]",
	valid_elements: "*[*], a[name|href|target|title|alt],"+ "span[class|style],hr,i[class]",
    ...
    toolbar1: "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image code fontsizeselect", file_browser_callback: RoxyFileBrowser}); //fontselect 
...
function RoxyFileBrowser(field_name, url, type, win) {
	...
	{
	var pathz = window.location.pathname.replace(/^\/([^\/]*).*$/, '$1');
	var roxyFileman =  location.protocol + "//" + location.host +'/'+ pathz +'/admin/include/tinymce/plugins/fileman';
	} else {
	var roxyFileman =  location.protocol + "//" + location.host +'/admin/include/tinymce/plugins/fileman';
	}
