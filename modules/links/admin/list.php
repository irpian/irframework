...
function getTitleUrl($string){
	...
	$name = str_replace(array(".html", "-"), array("", " "), $string_array[5]);
	$name = ucwords($name);
	return $name;
}
?>
...
<div class="row">
	<div class="col-md-12">
		  <table class="table">
			...
			<tr>
				<td><a href="<?php echo base_url."/$module/"."?url=".$data['url']; ?> " target="_blank"><?php echo getTitleUrl($data['url']); ?></a></td>
				<td>
					<?php
				...
				<td>
					<div class="group-action btn-group pull-right">
					  ...
					  <?php //action("detail", $module, $data['id'], $page, ""); ?>
