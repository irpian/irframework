...
<html lang="en">
 <head>
	...
	<?php echo $setting["plugin_google_analityc"]; ?>
	<?php echo $setting["plugin_facebook_script"]; ?>
 </head>
 <body>
	<header id="header">
		 <div class="container">
	...
	<main id="main">
		 <?php if($template['frame']=="clear"){
			include "include/module.switch.php";
			 } else { ?>
		 <section id="page<?php echo "-".$alias; ?>" class="page">
			<div class="container">
			 <div class="section-header">
				<h1 class="section-title"><?php echo $title_page; ?></h1>
